...
**Backups Location:** `/vercel/share/v0-project/dlc-backups/`
...
1. Document is added to `/vercel/share/v0-project/dlc-backups/` folder
...
**Documentation Root:** `/vercel/share/v0-project/docs-dlc/`
**Backups Root:** `/vercel/share/v0-project/dlc-backups/`
**Code:** `/vercel/share/v0-project/dice-link-companion/`
...
2. Read documents in numerical order (01 through 10)
3. Use cross-references to jump between related topics
4. Refer to specific sections when implementing changes

**All 11 files are now protected at repository root level.**
