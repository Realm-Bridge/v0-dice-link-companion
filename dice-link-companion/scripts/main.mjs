 ...
 * 
 * v1.0.6.53 - Reverted app.js extraction:
 * - App class kept in main.mjs due to tight coupling with content generation and listeners
 * - currentPanelDialog state remains in main.mjs for simplicity
 */
