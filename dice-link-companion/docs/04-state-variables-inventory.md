...
**Note:** This document inventories state variables in v1.0.6.72. When we restructure the code, regenerate this documentation using the same analysis process to reflect the new architecture.
