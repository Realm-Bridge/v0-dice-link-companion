 ...
 * 
 * v1.0.6.100 - CLEANUP: Consolidated duplicate getCollapsedSections/setCollapsedSections (now only in settings.js)
 * v1.0.6.99 - Phase 5 Step 5.4 COMPLETE: Extracted settings-helpers.js, moved handleMirroredDialogChange to dialog-mirroring.js
