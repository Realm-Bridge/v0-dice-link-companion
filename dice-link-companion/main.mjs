 ...
 * 
 * v1.0.6.108 - CLEANUP: Eliminated ALL window.diceLink global namespace coupling - now fully modular
 * v1.0.6.107 - Fixed count success modifiers (cs, cf): Now uses Foundry's _evaluateTotal()
